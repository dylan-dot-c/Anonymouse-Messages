       ...
       <form
        ...
        <div className="space-y-4 mt-4">
                ...
                <div className="relative">
                    <input type="text" id="firstname" className="floating-input peer" name="firstname" placeholder="" ref={firstNameInputReference}/>
                    <label htmlFor="firstname" className="floating-label">Firstname</label>
                </div>
                
                <div className="relative">
                    <input type="text" id="lastname" className="floating-input peer" name="lastname" placeholder="" ref={lastNameInputReference}/>
                    <label htmlFor="lastname" className="floating-label">Lastname</label>
                </div>
                
                <div className="relative">
                    <input type="text" id="username" className="floating-input peer" name="username" placeholder="" ref={usernameInputReference}/>
                    <label htmlFor="username" className="floating-label">Username</label>
                </div>

                <div className="relative">
                    <input type="text" id="email" className="floating-input peer" name="email" placeholder="" ref={emailInputReference}/>
                    <label htmlFor="email" className="floating-label">Email</label>
                </div>
            
                <div className="relative">
                    <input type={isChecked ? "text" : "password"} id="password" className="floating-input peer" placeholder="" ref={passwordInputReference}/>
        ...
        <div className="mt-4">
            <input type="checkbox" checked = {isChecked} onChange={handleShowPasswordChange} name="showPassword" id="showpassword"/>
