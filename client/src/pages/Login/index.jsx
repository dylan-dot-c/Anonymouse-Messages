        ...
        <form
            ...
            <div className="space-y-4 mt-4">
                ...
                <div className ="relative">
                    <input type="text" id="username" className="floating-input peer" name="username" ref={usernameInputReference}/>
                    <label htmlFor="username" className="floating-label">Username</label>
                </div>
                <div className ="relative">
                    <input type={isChecked ? "text" : "password"} name="password" id="password" className="floating-input peer" ref={passwordInputReference}/>
